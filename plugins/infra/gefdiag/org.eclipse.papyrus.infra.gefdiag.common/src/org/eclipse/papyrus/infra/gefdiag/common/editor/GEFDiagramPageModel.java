...
public abstract class GEFDiagramPageModel implements IEditorModel {

	private Diagram diagram;

	private Image tabImage;

	public GEFDiagramPageModel(Diagram diagram) {
	...
	@Override
	public abstract IEditorPart createIEditorPart() throws PartInitException;
