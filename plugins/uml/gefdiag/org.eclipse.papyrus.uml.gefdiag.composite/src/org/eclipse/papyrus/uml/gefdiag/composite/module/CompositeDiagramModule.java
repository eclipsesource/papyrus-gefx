...
public class CompositeDiagramModule extends UMLDiagramModule {
	...
	protected void bindLocators(Multibinder<HelperProviderParticipant<Optional<Locator>>> locators) {
		...
		locators.addBinding().toInstance(new GMFProviderParticipant<>(DEFAULT_COMPOSITE_PRIORITY, borderItemLocator,
				PortEditPart.class, ParameterEditPart.class));
	}

	protected void bindPalette() {
		bind(PreferencesHint.class).toInstance(new PreferencesHint("org.eclipse.papyrus.uml.diagram.composite"));
