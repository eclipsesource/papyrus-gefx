...
/**
 * <p>
 * Anchor representing the Start point of a Connection or Node.
 * </p>
 * <p>
 * For {@link Connection Connections}, this corresponds to {@link Connection#getStartPoint()}. For {@link Node Nodes},
 * this corresponds to the Top-Center point of the Node bounds.
 * </p>
 */
public class StartAnchor extends AbstractAnchor {

	public StartAnchor(Node anchorage) {
		super(anchorage);
	}
