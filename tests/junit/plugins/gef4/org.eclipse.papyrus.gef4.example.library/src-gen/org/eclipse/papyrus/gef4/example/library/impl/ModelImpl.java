 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.papyrus.gef4.example.library.impl.ModelImpl#getLibrary <em>Library</em>}</li>
 *   <li>{@link org.eclipse.papyrus.gef4.example.library.impl.ModelImpl#getPersons <em>Persons</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ModelImpl extends MinimalEObjectImpl.Container implements Model {
	...
	public EList<Library> getLibrary() {
		if (library == null) {
			library = new EObjectContainmentEList<Library>(Library.class, this, LibraryPackage.MODEL__LIBRARY);
		}
		return library;
	}
	...
	public EList<Person> getPersons() {
		if (persons == null) {
			persons = new EObjectContainmentEList<Person>(Person.class, this, LibraryPackage.MODEL__PERSONS);
		}
		return persons;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case LibraryPackage.MODEL__LIBRARY:
				return ((InternalEList<?>)getLibrary()).basicRemove(otherEnd, msgs);
			case LibraryPackage.MODEL__PERSONS:
