...
import org.eclipse.papyrus.gef4.example.library.LibraryFactory;
import org.eclipse.papyrus.gef4.example.library.LibraryPackage;
import org.eclipse.papyrus.gef4.example.library.Model;
...
public class LibraryPackageImpl extends EPackageImpl implements LibraryPackage {
	 ...
	 * @see org.eclipse.papyrus.gef4.example.library.LibraryPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getAuthor_WrittenBooks() {
	 ...
	 * @generated
	 */
	public EReference getPerson_Borrows() {
	 ...
	 * @generated
	 */
	public EReference getModel_Library() {
	...
	public void createPackageContents() {
		...
		createEReference(authorEClass, AUTHOR__WRITTEN_BOOKS);

		personEClass = createEClass(PERSON);
		createEReference(personEClass, PERSON__BORROWS);

		modelEClass = createEClass(MODEL);
		createEReference(modelEClass, MODEL__LIBRARY);
	...
	public void initializePackageContents() {
		...
		initEReference(getBook_Authors(), this.getAuthor(), this.getAuthor_WrittenBooks(), "authors", null, 1, -1, Book.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(authorEClass, Author.class, "Author", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getAuthor_WrittenBooks(), this.getBook(), this.getBook_Authors(), "writtenBooks", null, 0, -1, Author.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(personEClass, Person.class, "Person", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPerson_Borrows(), this.getBook(), null, "borrows", null, 0, -1, Person.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(modelEClass, Model.class, "Model", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getModel_Library(), this.getLibrary(), null, "library", null, 0, -1, Model.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
